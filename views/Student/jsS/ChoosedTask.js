...
var taskKey = decodeURIComponent(arrInfo[0].split('=')[1])
...
database.ref('departments/'+department+"/specialities/"+speciality+"/groups/"+group+"/Subjects/"+subject+"/tasks/"+taskKey).once('value').then(function(snapshot){
